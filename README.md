...
Step 1, under Extensions, click details:
...
Step 2, click Extension options:
...
Step 4, click keyboard shortcuts on the sidebar [optional]:
...
Step 5, set a keyboard shortcut [optional]:
...
Step 6, on an application page, click the extension icon or use the configured keyboard shortcut:
...
Step 7, the fields should now be filled as configured:
